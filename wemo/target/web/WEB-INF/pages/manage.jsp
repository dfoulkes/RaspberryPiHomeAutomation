  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="panel panel-default">
        <div class="panel-heading">All Components</div>
        <div class="panel-body">
          ...
          <div>
           <a href="#/add/" class="btn btn-primary menu_button_margin">Add</a><a href="#/update/" class="btn btn-primary menu_button_margin">Update</a>
          </div>
        </div>
      </div>
    </div>
